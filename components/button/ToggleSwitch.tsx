...
const ToggleSwitch: React.FC<ToggleSwitchProps> = ({ option1, option2, color1='green', color2='green' }) => {
  ...
  return (
    <TouchableOpacity style={[styles.switchContainer, { backgroundColor }]} onPress={handleToggle}>
